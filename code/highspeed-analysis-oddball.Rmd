...
decoding_accuracy <- function(accuracy, alt_label){
  ...
  acc_baseline = 100/5
  # TODO: with ensemble classifiers, does this have to be 0?
...
```{r, echo=FALSE, class.source=NULL, fig.width=1, fig.height=3}
...
```{r, include=FALSE, eval=FALSE, echo=FALSE}
ggsave(filename = "highspeed_plot_decoding_single_trial_activation_cat.pdf",
